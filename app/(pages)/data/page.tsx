          ...
          <div className="bg-secondary flex flex-grow justify-center rounded-sm border-background mt-1 pt-0">
            <Card className="flex w-2/4 m-5 p-10 flex-col text-left bg-secondary border-none shadow-none">
              ...
              <CardDescription className="text-[18px]">
                ...
                right to commission external service providers to support us in
                providing our services. These service providers are
            ...
            <Card className="flex w-2/4 m-5 p-10 flex-col text-left bg-secondary border-none shadow-none">
              ...
              <CardDescription className="text-[18px]">
                ...
                for advertising purposes or to create user profiles. You can set
                your browser so that it does not accept cookies or so that it
                informs you before a cookie is stored. Please note, however,
                that some functions of our website may not be available or may
              ...
              <CardDescription className="text-[18px]">
                ...
                contrary. You also have the right to request the restriction of
                the processing of your personal data or to object to the
              ...
              <CardDescription className="text-[18px]">
                ...
                about how your personal data is handled.
              </CardDescription>
